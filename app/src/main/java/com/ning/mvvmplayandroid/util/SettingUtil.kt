package fule.com.playandroidkotlin.ui.util
 ...
 */
object SettingUtil {
    private val setting = PreferenceManager.getDefaultSharedPreferences(App.Companion.context)
...
/*
    fun getIsNoPhotoMode(): Boolean {
        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtil.isMobile(App.getContext())
    }
*/
